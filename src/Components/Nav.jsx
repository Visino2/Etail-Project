    ...
    return (
        <div className="flex flex-row justify-between items-center mx-4 my-4 rounded-full border-0 bg-gray-100 px-8 py-4">
           ...
           <div className="space-x-4">
            <a href="/contact" className="rounded-2xl px-5 py-2 border-0 bg-white text-blue-500 cursor-pointer">Login</a>
            <a href="/notfound" className="bg-blue-700 px-4 py-2 rounded-2xl text-white hover:bg-blue-800 cursor-pointer">Start selling</a>
           </div>
        </div>
    )
}